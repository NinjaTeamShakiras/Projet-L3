...
class AvisEntreprise extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('note_generale_avis_entreprise, date_creation_avis_entreprise, id_entreprise', 'required'),
			...
			array('id_avis_entreprise, note_generale_avis_entreprise_avis_entreprise, date_creation, nb_signalements_avis_entreprise, id_entreprise, id_utilisateur', 'safe', 'on'=>'search'),
		);
	}
