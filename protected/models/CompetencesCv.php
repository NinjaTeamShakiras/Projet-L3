...
/**
 * This is the model class for table "competences_cv".
 *
 * The followings are the available columns in table 'competences_cv':
 ...
 */
class CompetencesCv extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_competence, nom_competence', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('nom_competence',$this->nom_competence,true);
	 ...
	 * @return CompetencesCv the static model class
	 */
