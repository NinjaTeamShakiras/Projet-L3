...
INSERT INTO `prozzl_test`.`employe`(`nom_employe`, `prenom_employe`, `date_naissance_employe`, `employe_travaille`, 			`mail_employe`, 	`telephone_employe`, 	`id_adresse`)
	SELECT 							'Muraton',		'Francky',						'1748-02-18',				1,				'FranckyMuraton@prozzl_test.fr',		'0605040302',			id_adresse
		FROM adresse
	WHERE id_adresse = 4 ;

INSERT INTO `prozzl_test`.`employe`(`nom_employe`, `prenom_employe`, `date_naissance_employe`, `employe_travaille`, 			`mail_employe`, 	`telephone_employe`, 	`id_adresse`)
	SELECT 							'Sacquet',		'Frodon',						'2-05-08',				0,				'FrodonSacquet@prozzl_test.fr',		'0687976434',			id_adresse
		FROM adresse
	WHERE id_adresse = 5 ;	
